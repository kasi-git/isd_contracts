...
ACTION slvrtoken::issue( name to, asset quantity, string memo )
{
...
//    require_auth2(name("amprllc"), name("issue"));
    ...
    // destroys IOU tokens from customer account
...
ACTION slvrtoken::lock( asset lock )
{
...
void slvrtoken::sub_balance( name owner, asset value )
{
